...
import { EditRecipe, TextOverlay, MultiTrackEditorState, OverlayPosition } from "@/lib/types";
  ...
  return (
    <>
      ...
      >
        ...
        <button
          type="button"
          className="absolute inset-0 z-10 cursor-pointer appearance-none bg-transparent border-0 p-0"
          onClick={() => {
            if (videoRef.current) {
