      ...
      <div className="max-w-6xl mx-auto px-4 py-8 pb-6 flex-1 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-5">
          ...
          <div className="space-y-6 min-w-0">
            <div className="bg-[var(--surface)] rounded-2xl p-6 border border-[var(--border)] shadow-card hover:shadow-card-hover transition-shadow duration-300 animate-fade-in">
          ...
          <div className={cn(
            ...
            <button
              ...
              className={cn(
                "w-full flex items-center justify-center gap-3 py-5 min-h-[56px] rounded-2xl",
                "font-display text-2xl tracking-widest transition-all duration-300",
                file && !isProcessing
                  ? "bg-film-600 hover:bg-film-500 hover:-translate-y-1 text-white shadow-glow hover:shadow-glow-lg active:scale-[0.98] cursor-pointer"
